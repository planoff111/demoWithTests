...
import static com.example.demowithtests.domain.Gender.M;
...
public class RepositoryTests {
    ...
    public void findByGenderTest() {
        ...
        var employees = employeeRepository.findByGender(M.toString(), "UK");

        assertThat(employees.get(0).getGender()).isEqualTo(M);
    }
    ...
    @Order(7)
    @Rollback(value = false)
    @DisplayName("Find all Ukrainian")
    void findAllukraineTest() {
        ...
        assertThat(ukrainians.isEmpty()).isFalse();

        assertThat(ukrainians.stream().anyMatch(e -> e.contains(empl.getCountry())));
